...
InfoText 	db	"PERYFERiAH tEAM PrEsEnT",13,13
			db  "MetaProducts Portable",0FFh
			db  "Download Manager v3.8.827",0FFh
			db  ":: kEyGeN . iNc . PaTcH ::",0FFh,13
			db  "gfx'ed & keygenned by",13
			db  "r0ger ^ PRF",0FFh,13
			db  "protection used:",13
			db  "RSA-570 + base64",0FFh
			db  "(incl. all blacklisted names)",0FFh,13,13,13
			db  "all the greetz go 2 all",13
			db  "PRF memberz and friends",13
			db  "and to all TSRh , exetools",13
			db  "and board4all.biz thugz.",13,13
			db  "check out the aboutbox",13
			db  "for the greetz.",13,13
			db  "anyway, fuck da ripperz,",13
			db  "death 2 all lamerz.",13,13
			db  "see ya ;)",0FFh,0
...
loc_4014A0:
		invoke SetTextColor,hdcSrc,00FF64E4h
